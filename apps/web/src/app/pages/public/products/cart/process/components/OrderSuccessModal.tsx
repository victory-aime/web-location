    ...
    >
      <Center flexDir={'column'} gap={4}>
        ...
        <BaseText textAlign={'center'} lineHeight={'1.8'}>
          Merci pour vos achats ! Votre commande n'a pas encore été expédiée, mais nous vous enverrons un email lorsque
          ce sera fait.
        </BaseText>
        <Box width={'full'}>
          <BaseButton width={'full'} bg={'gray'} onClick={() => router.push(APP_ROUTES.PUBLIC.HOME)}>
            Revenir a l'acceuil
          </BaseButton>
          <BaseButton
            width={'full'}
