  ...
  return (
    <Center flexDir={'column'}>
      <BaseText mt={2} color={textColor}>
        Actuellement, le paiement s'effectue à la livraison. Les frais de livraison peuvent varier en fonction de votre
        adresse. Vous serez informé du montant exact lors de la confirmation de votre commande avec le marchand.
      </BaseText>
      <Flex mt={5}>
        <Previous>
