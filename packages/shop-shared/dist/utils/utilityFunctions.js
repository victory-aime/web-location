 ...
 */
export const convertDateFormat = (date, inputFormat = APP_DATE_FORMAT) => {
 ...
 */
export const getPeriodInMonths = (nbePeriod, period) => {
  switch (period) {
    case 'QUARTERLY':
      return nbePeriod * 3
    case 'SEMIANNUAL':
 ...
 */
export const formatDateFormAuditTable = (date) => {
 ...
 */
function differenceInDays(now, date) {
 ...
 */
export const findDynamicIdInList = (id, list) => {
 ...
 */
export const parseDateString = (date, inputFormat = APP_DATE_FORMAT) => {
  if (!date) return null
 ...
 */
export const formatDisplayDate = (date, inputFormat = APP_DATE_PATTERN) => {
  if (!date) return null
  let parsed = null
 ...
 */
export const getMonthFromDateString = (dateString, inputFormat = APP_DATE_FORMAT, locale = 'fr') => {
 ...
 */
export const convertToCreatedUpdatedInfo = (data) => {
 ...
 */
export const compressImagesFiles = async (file) => {
  const options = {
