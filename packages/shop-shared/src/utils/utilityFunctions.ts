 ...
 */
export const convertDateFormat = (date: string | Date, inputFormat: string = APP_DATE_FORMAT): string => {
 ...
 */
export const getPeriodInMonths = (nbePeriod: number, period: 'QUARTERLY' | 'SEMIANNUAL' | 'ANNUAL' | string): number => {
  switch (period) {
    case 'QUARTERLY':
      return nbePeriod * 3
    case 'SEMIANNUAL':
 ...
 */
export const parseDateString = (date: Date | string | null | undefined, inputFormat: string = APP_DATE_FORMAT): Date | null => {
  if (!date) return null
 ...
 */
export const formatDisplayDate = (date: Date | string | null | undefined, inputFormat: string = APP_DATE_PATTERN): string | null => {
  if (!date) return null
 ...
 */
export const getMonthFromDateString = (dateString: string, inputFormat: string = APP_DATE_FORMAT, locale: string = 'fr'): string | null => {
