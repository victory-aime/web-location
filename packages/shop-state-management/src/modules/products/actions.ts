...
export const publicProductRequestAction = (payload?: any) => ({
  type: Constants.PUBLIC_PRODUCTS,
  payload,
})

export const publicProductRequestActionSuccess = (payload: any) => ({
  type: Constants.PUBLIC_PRODUCTS_SUCCESS,
  payload,
})

export const publicProductRequestActionFailed = (payload: any) => ({
