...
import { publishProductsData } from '../data/productData';
import { RenderProductImage } from './RenderProductImage';

export const PublishProductList = () => {
  const pageSize = 10;
  const totalPages = Math.ceil(publishProductsData?.length / pageSize);
