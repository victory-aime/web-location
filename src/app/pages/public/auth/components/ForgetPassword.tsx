...
const ForgetPassword = ({ open, onChange }: { open: boolean; onChange: (value: any) => void }) => {
      ...
      {({ handleSubmit, values }) => (
        ...
        >
          <VStack alignItems={'flex-start'} gap={6} mt={4} width={'100%'}>
            <Text>
              Veuillez saisir votre email un code sera envoye vous permettant de reinitialiser votre
              mot de passe
            </Text>
            <FormTextInput
              required
