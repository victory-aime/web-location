...
import Raiting from "_/components/custom/raiting/Raiting";
import { IProductMoalProps } from "./interface/modal-product";

export const ProductDetails: FC<IProductMoalProps> = ({
  isOpen,
  onChange,
  selectedValues,
}) => {
      ...
      <Box>
        <Flex width={"full"} gap={4}>
          ...
          >
            <Image
              src={
                (selectedValues?.product?.images &&
                  selectedValues?.product?.images[0]) ??
